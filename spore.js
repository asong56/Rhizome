...
.w{display:inline-flex;align-items:center;font-family:-apple-system,BlinkMacSystemFont,"Helvetica Neue",sans-serif;font-size:12px;letter-spacing:.04em;border:1px solid ${br};border-radius:20px;background:${bg};color:${fg};backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);overflow:hidden;user-select:none}
...
b{all:unset;cursor:pointer;padding:7px 13px;opacity:.5;background:radial-gradient(ellipse at 50% 50%,${ink} 0%,transparent 65%);background-size:0 0;background-position:50% 50%;background-repeat:no-repeat;transition:opacity .18s,background-size .5s cubic-bezier(.22,1,.36,1)}
